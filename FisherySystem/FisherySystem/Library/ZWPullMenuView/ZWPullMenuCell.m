...
-(void)setMenuModel:(ZWPullMenuModel *)menuModel{
    ...
    if (!menuModel.imageName.length) {
        ...
        self.menuTitleLab.frame = CGRectMake(self.zw_menuConfg.zw_menuContentMargin * 2 + self.zw_menuConfg.zw_menuImageWidth - 5, 0, CGRectGetWidth(self.bounds) - (self.zw_menuConfg.zw_menuContentMargin * 3 + self.zw_menuConfg.zw_menuImageWidth - 5), CGRectGetHeight(self.bounds));
    }
