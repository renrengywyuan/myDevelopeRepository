...
- (void)setType:(HXConfigurationType)type {
    ...
    if (type == HXConfigurationTypeWXChat) {
        ...
        self.videoMaximumSelectDuration = 60.f * 5.f; // 60.f * 5.f;
        self.selectVideoBeyondTheLimitTimeAutoEdit = NO;
        self.photoMaxNum = 0;
        self.videoMaxNum = 0;
        self.maxNum = 10;
        ...
        [self setWxConfiguration];
        self.videoMaximumDuration = 7200;
        self.videoMaximumSelectDuration = 7200; // 选择视频最大的时间长
...
- (void)setWxConfiguration {
    ...
    self.cellSelectedBgColor = [UIColor hx_colorWithHexStr:@"#FADC4F"];
    self.cellSelectedTitleColor = [UIColor whiteColor];
    self.cellDarkSelectBgColor = wxColor;
    self.cellDarkSelectTitleColor = [UIColor whiteColor];
    self.previewSelectedBtnBgColor = [UIColor hx_colorWithHexStr:@"#FADC4F"];
    ...
    self.bottomDoneBtnBgColor = [UIColor hx_colorWithHexStr:@"#FADC4F"];
    ...
    self.bottomDoneBtnTitleColor = [UIColor blackColor];
